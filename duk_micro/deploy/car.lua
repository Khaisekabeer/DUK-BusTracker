...
function setup()
  return {
    ...
    -- tags disallow access to in combination with highway=service (empty so campus service roads are allowed)
...
function process_way(profile, way, result, relations)
  ...
  handlers = Sequence {
    ...
    -- Enable full bidirectional routing on all roads so bus GPS tracking is never blocked by median dividers
